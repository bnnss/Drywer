...
export default class Start extends Component {
    ...
    async facebook () {
        ...
        if(type === "succes") {
            ...
            firebase.auth().signInWithCredential(credentials)
                .catch(error => {
                    Toast.showWithGrawvity("Error accediendo con facebook", Toast.LONG, Toast.BOTTOM);
                })
        } else if(type === "cancel") {
    ...
    render () {
        return (
            <BackgroundImage source = {require("../../assets/images/esquizo.jpg")}>
                <View style={{justifyContent: "center", flex: 1}}>
                    <AppButton
                        bgColor="rgba(111, 38, 73, 0.7)"
                        title="Entrar "
